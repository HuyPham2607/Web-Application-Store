...
function ShortMen() {
    ...
    const identifiedProduct = prodFilter.filter((p) => p.identified === 'Shorts');
            ...
            <div className=" py-5 wrapper-item">
                ...
                <div className="containers">
                    <aside className="sidebar open" data-sidebar id="idSidebar">
                        ...
                        <div className="top-sidebar" onClick={routeHoodies}>
                            <ul>Short</ul>
                        </div>
