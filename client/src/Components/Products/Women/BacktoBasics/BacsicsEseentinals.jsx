...
function BacsicsEseentinals() {
    ...
    const identifiedProduct = prodFilter.filter((p) => p.identified === 'BacsicsEseentinals');
            ...
            <div className=" py-5 wrapper-item">
                ...
                <div className="header-filter ">
                    <div className="d-flex ">
                        <span onClick={routeClubFootball}>
                            <span className="headline-page-route">Club Football</span>
                        </span>
                    </div>
                ...
                <div className="containers">
                    <aside className="sidebar open" data-sidebar id="idSidebar">
                        <div className="top-sidebar" onClick={routeClubFootball}>
                            <ul>Club FootBall</ul>
                        </div>
...
export default BacsicsEseentinals;
