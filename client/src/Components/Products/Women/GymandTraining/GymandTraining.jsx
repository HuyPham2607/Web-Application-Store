...
function GymandTraining() {
    ...
    const identifiedProduct = prodFilter.filter((p) => p.title === 'Men' && p.identified === 'GymandTraining');
    let showProducts;
    if (sortby === '') {
            ...
            <div className=" py-5 wrapper-item">
                ...
                <div className="header-filter ">
                    <div className="d-flex ">
                        <span onClick={routeJordan}>
                            <span className="headline-page-route">Jordan</span>
                        </span>
                        <span onClick={routeRunning}>
                            <span className="headline-page-route">Running</span>
                        </span>
                        <span onClick={routeGymandTraining}>
                            <span className="headline-page-route">Gym and Training</span>
                        </span>
                    </div>
                ...
                <div className="sidebar-talet close-sidebar-tablet" id="filter-tablet">
                    ...
                    <div className="mx-5 sidebar-bottom-filter">
                        <button onClick={HandleCloseFilter} className="btn-bottom-apply">
                            Apply
                        </button>
                    </div>
                </div>
