...
function ClubFootBall() {
    ...
    const routeBacsicsEseentinals = (_id) => {
    ...
    const identifiedProduct = prodFilter.filter((p) => p.identified === 'Football');
            ...
            <div className=" py-5 wrapper-item">
                ...
                <div className="header-filter ">
                    <div className="d-flex ">
                        <span onClick={routeBacsicsEseentinals}>
                            <span className="headline-page-route">Bacsics Eseentinals</span>
                        </span>
                    </div>
                ...
                <div className="containers">
                    <aside className="sidebar open" data-sidebar id="idSidebar">
                        <div className="top-sidebar" onClick={routeBacsicsEseentinals}>
                            <ul>Bacsics Eseentinals</ul>
                        </div>
